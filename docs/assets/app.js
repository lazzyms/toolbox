(() => {
  ...
  const downloads = {
    macos: {
      href: 'https://github.com/lazzyms/toolbox/releases/download/tauri-v0.1.11/Toolbox-0.1.11-macos.dmg',
      label: 'Download for macOS',
      detail: 'Apple silicon · DMG',
    },
    'windows-x64': {
      href: 'https://github.com/lazzyms/toolbox/releases/download/tauri-v0.1.11/Toolbox-windows-x86_64-setup.exe',
      label: 'Download for Windows x64',
      detail: 'Intel or AMD · EXE installer',
    },
    'windows-arm64': {
      href: 'https://github.com/lazzyms/toolbox/releases/download/tauri-v0.1.11/Toolbox-windows-arm64-setup.exe',
