...
export const PDFPathsView = ({ utility, mode }: { utility: ToolDefinition; mode: "merge" | "split" }) => {
    ...
    return <ToolScaffold utility={utility} onRun={(paths) => mode === "merge"
        ...
        : invoke<ToolResult>("split_pdf", { request: { paths, pages: [], pageRanges: splitMode === "ranges" ? ranges : null, splitMode, chunkSize: splitMode === "chunks" ? Number(chunkSize) : null, outputLocation: "alongsideInput" } })}>
