...
const UtilityMetadata: Array<Omit<ToolDefinition, "capability" | "status">> = [
    ...
    { id: "office-protect", title: "Protect Office Files", shortTitle: "Protect Office", blurb: "Protect DOCX and XLSX files with a verified local writer.", symbol: "lock", tint: "#ef4444", category: "Documents", command: "protect_office", verification: "protect-office", view: "office-protect" },
