...
export const UtilityRegistry: ToolDefinition[] = [
    ...
    pdf("pdf-crop", "Crop PDF", "Crop", "Trim PDF margins or cut to a region without re-encoding.", "crop", "#10b981", "crop_pdf", "pdf-crop"),
    ...
    pdf("pdf-sign", "Sign PDF", "Sign", "Stamp a signature image or typed name onto PDF pages.", "signature", "#ec4899", "sign_pdf", "pdf-sign"),
    ...
    pdf("pdf-organize", "Organize PDF", "Organize", "Reorder, rotate, and delete PDF pages from a thumbnail grid.", "layout-grid", "#06b6d4", "organize_pdf", "pdf-organize"),
